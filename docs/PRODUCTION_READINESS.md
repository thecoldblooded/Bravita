...
- Vercel/Node runtime: `SUPABASE_URL`, `SUPABASE_ANON_KEY`, `FIREBASE_API_KEY`, `SITE_URL`, `ALLOWED_AUTH_ORIGINS`, `ALLOWED_RECOVERY_REDIRECT_ORIGINS`, `HCAPTCHA_SECRET_KEY`, `COUNTERAPI_*`
