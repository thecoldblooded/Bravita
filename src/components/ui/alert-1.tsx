...
const alertVariants = cva('flex items-stretch w-full gap-2 group-[.toaster]:w-(--width)', {
    ...
    compoundVariants: [
        ...
        },
        {
            ...
            appearance: 'outline',
            className:
                'border border-border bg-background text-[var(--color-info,var(--color-cyan-600))] [&_[data-slot=alert-close]]:text-foreground',
        },
        {
            variant: 'warning',
            appearance: 'outline',
        ...
        },
        {
            variant: 'mono',
            icon: 'info',
            className: '[&_[data-slot=alert-icon]]:text-[var(--color-info-foreground,var(--color-cyan-600))]',
        },
    ],
    defaultVariants: {
        variant: 'secondary',
