...
-- Update create_order to use settings
...
BEGIN
    ...
    IF p_promo_code IS NOT NULL THEN
        -- Call check_promo_code or similar logic
        -- For now, we'll assume the frontend validated it, 
        -- but ideally re-validate here.
        -- Assuming a trigger or another function handles promo calculation
    END IF;
